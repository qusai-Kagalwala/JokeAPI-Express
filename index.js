...
app.put("/jokes/:id", (req, res) => { 
  ...
  const searchIndexindex = jokes.findIndex((joke) => joke.id === id);

  jokes[searchIndexindex] = replacementJoke;
...
app.delete("/all", (req, res) => {
  ...
  if (userkey === masterKey) {
    ...
    res.sendStatus(404);
    res.json({ error: "Unauthorized. Please provide the correct key." });
  }
});
